...
VIAddVersionKey ProductName Honey
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-honey executable and locales:
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall Honey.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall Honey.lnk"
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Honey.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\Honey.lnk"
