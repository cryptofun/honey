...
/**
  Honey GUI main class. This class represents the main window of the Honey UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HoneyGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit HoneyGUI(QWidget *parent = 0);
    ~HoneyGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a honey wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
