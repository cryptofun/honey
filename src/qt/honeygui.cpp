...
void HoneyGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Honey address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/honey"), tr("&About Honey"), this);
    aboutAction->setToolTip(tr("Show information about Honey"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Honey"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/honey"), tr("&Show / Hide"), this);
...
void HoneyGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/honey_testnet"));
            setWindowIcon(QIcon(":icons/honey_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/honey_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Honey client") + QString(" ") + tr("[testnet]"));
...
void HoneyGUI::setWalletModel(WalletModel *walletModel)
{
...
void HoneyGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Honey client"));
...
#ifndef Q_OS_MAC
void HoneyGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void HoneyGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Honey network", "", count));
}

void HoneyGUI::setNumBlocks(int count)
{
...
void HoneyGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("Honey") + " - ";
...
void HoneyGUI::changeEvent(QEvent *e)
{
...
void HoneyGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void HoneyGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(HoneyUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void HoneyGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(HoneyUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void HoneyGUI::gotoOverviewPage()
{
...
void HoneyGUI::gotoAddressBookPage()
{
...
void HoneyGUI::gotoSendCoinsPage()
{
...
void HoneyGUI::gotoSignMessageTab(QString addr)
{
...
void HoneyGUI::gotoVerifyMessageTab(QString addr)
{
...
void HoneyGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void HoneyGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Honey address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void HoneyGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void HoneyGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void HoneyGUI::changePassphrase()
{
...
void HoneyGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void HoneyGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void HoneyGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void HoneyGUI::updateStakingIcon()
{
    updateWeight();
