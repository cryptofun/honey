...
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE BOOST_NO_CXX11_SCOPED_ENUM
...
contains(HONEY_NEED_QT_PLUGINS, 1) {
    DEFINES += HONEY_NEED_QT_PLUGINS
...
SOURCES += src/qt/honey.cpp src/qt/honeygui.cpp \
    ...
    src/qt/honeyaddressvalidator.cpp \
    src/chainparams.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/txmempool.cpp \
    ...
    src/qt/honeystrings.cpp \
    src/qt/honeyamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/honey.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/honey_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/honey-qt.rc
...
windows:RC_FILE = src/qt/res/honey-qt.rc
...
macx:ICON = src/qt/res/icons/honey.icns
macx:TARGET = "Honey-Qt"
